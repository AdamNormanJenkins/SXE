...
/**
 * Thrown when the system tries to retrieve a html page that isn't a html page.
 *
...
public class UnsupportedPageTypeException extends Exception{
    ...
    public UnsupportedPageTypeException(String url){
        super("URL is not a valid HTML page: " + url);
    }
