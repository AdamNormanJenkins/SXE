...
/**
 * Test that a token is called at least a number of times.
 * 
 * @author <a href="mailto:opensource@adamjenkins.net">Adam Norman Jenkins</a>
 */
public class AssertCalledAtLeastNegativeTest extends XSLTBasedTest{

    
    @Override
    protected void processResults(String output, XSLTErrorListener listener){
        assertSingleError("Element with id sectortoken was called 2 times, but was supposed to be called 3 times.", listener);
    }
}
