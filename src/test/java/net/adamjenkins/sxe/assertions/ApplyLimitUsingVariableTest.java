...
/**
 * Test for applyLimit functionality.
 * 
 * @author <a href="mailto:opensource@adamjenkins.net">Adam Norman Jenkins</a>
 */
public class ApplyLimitUsingVariableTest extends XSLTBasedTest {

    @Override
    protected void processResults(String output, XSLTErrorListener listener){
        assertSingleError("The limit for key 'mylimit' of 2 was exceeded.", listener);
    }
}
