...
/**
 * Test that a token is called.
 * @author <a href="mailto:opensource@adamjenkins.net">Adam Norman Jenkins</a>
 */
public class AssertCalledNegativeTest extends XSLTBasedTest{

    @Override
    protected void processResults(String output, XSLTErrorListener listener) {
        assertSingleError("Element with id token was called 2 times, but was supposed to be called 3 times.", listener);
    }
}
