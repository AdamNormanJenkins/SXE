...
/**
 * Tests the assert equals functionality.
 * 
 * @author <a href="mailto:opensource@adamjenkins.net">Adam Norman Jenkins</a>
 */
public class AssertEqualNegativeTest extends XSLTBasedTest{

    @Override
    protected void processResults(String output, XSLTErrorListener listener) {
        assertSingleError("Assertion failed (assertEqual), arg1 and arg2 are not equal.", listener);
    }
