...
/**
 * Test the assert exists functionality.
 *
 * @author <a href="mailto:opensource@adamjenkins.net">Adam Norman Jenkins</a>
 */
public class AssertExistsNegativeTest extends XSLTBasedTest{

    @Override
    protected void processResults(String output, XSLTErrorListener listener) {
        assertSingleError("Assertion failed (assertExists), result of expression industry-details/nonexistant is null", listener);
    }
