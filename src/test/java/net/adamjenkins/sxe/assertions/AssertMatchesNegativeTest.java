...
/**
 * Test the assertion matches functionalit.
 * 
 * @author <a href="mailto:opensource@adamjenkins.net">Adam Norman Jenkins</a>
 */
public class AssertMatchesNegativeTest extends XSLTBasedTest{

    @Override
    protected void processResults(String output, XSLTErrorListener listener) {
        assertSingleError("Assertion failed (matches): 'Oil & Gas Drilling' does not match the regular expression '\\d{3}'", listener);
    }
